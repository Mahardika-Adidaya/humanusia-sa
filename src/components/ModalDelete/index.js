                ...
                <div className={`max-h-[700px] overflow-auto shadow-lg bg-white rounded-[12px] px-[41px] py-[37px] scrollbar-hide w-[500px]`}>
                    ...
                    <div className='mt-6 flex flex-col justify-center items-center gap-5'>
                        ...
                        <div className='flex item-center justify-center gap-3 mt-5'>
                            <button onClick={buttonClose} className='bg-[#ECECEC] text-[#003049] text-sm rounded-[6px] w-[100px] py-[10px] px-[25px]'>Cancel</button>
                            <button onClick={submitButton} className='bg-[#0E5073] text-white text-sm rounded-[6px] w-[100px] py-[10px] px-[25px]'>Delete</button>
                        </div>
                    </div>
                </div>
            </div>
